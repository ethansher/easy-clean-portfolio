  ...
  /* 6 — Criteria: Weight + Compactness */ {
    ...
    data: {
      ...
      cols: [
        ...
        { h: 'Compactness (continued)', text: 'A key advantage of achieving compactness is improved portability and organisation. Integrating multiple functions into a single, space-efficient unit reduces clutter and simplifies storage. However, compactness also introduces design challenges. Reducing overall size can limit internal space for components such as soap reservoirs, airflow channels, or hose fittings. If components are too tightly packed, this may complicate assembly, maintenance, or airflow efficiency. Product design literature notes that overly compact designs can lead to overheating, reduced performance, or difficulty in user interaction if not carefully planned.\n\nIf compactness is not achieved, the product may become impractical for its intended audience. A bulky or awkwardly shaped kit would discourage regular use and conflict with the project\'s goal of convenience. This could result in users returning to traditional methods, undermining both usability and sustainability aims.\n\nCompactness will be evaluated by measuring the final prototype\'s dimensions and testing its ability to fit within a standard car boot and small storage spaces. User trials will assess how easily the kit can be packed away after use. The minimum standard for success is that the fully assembled kit fits comfortably within a standard car boot and can be stored without disassembly, while still allowing all components to function effectively during use.' }
      ],
      highlights: [
        { h: 'Survey Finding — Weight Barrier', text: '65% of 30 P-plate drivers surveyed identified equipment being too heavy and bulky as a key barrier to washing their car more regularly. Safe Work Australia highlights that excessive weight in handheld equipment increases the risk of muscle fatigue and musculoskeletal strain.' },
        { h: 'Minimum Standards for Success', text: 'Weight: The fully assembled kit can be carried with one hand and used continuously for at least 10–15 minutes without reported fatigue or discomfort. Compactness: The kit fits comfortably within a standard car boot and can be stored without disassembly.' }
      ]
    }
  },

  /* 7 — Criteria: Shape + Colour */ {
    t: 'criteria',
    data: {
      cols: [
        { h: 'Shape', text: 'Shape in the context of this project refers to the overall form and geometry of the car-cleaning kit, including how its body, handles, and components are arranged and contoured. Shape influences how the product is held, balanced, stored, and visually understood by the user. For a handheld, portable cleaning kit, shape is closely linked to usability and comfort, as it determines how naturally the product fits in the user\'s hand and how easily it can be manoeuvred around a vehicle. A well-considered shape supports both function and ease of use, while a poorly designed shape can make the product awkward or uncomfortable to operate.\n\nThe goal of this criterion is to develop a shape that allows the kit to be comfortably handled with one or two hands, maintains good balance during use, and fits efficiently into storage spaces such as a car boot. Shape is particularly important for younger drivers, who may have less experience using tools and prefer products that feel intuitive rather than technical or intimidating. In an interview with a younger driver they stated: "A car cleaning kit that is shaped to allow for easier storage would make cleaning my car so much easier."' },
        { h: 'Shape (continued)', text: 'Research in industrial design highlights that products with clear, ergonomic forms improve user confidence and reduce handling errors because users can easily understand how the product should be held and used (Design Council UK). For this project, a streamlined, logical shape helps ensure the kit feels approachable and practical.\n\nOne advantage of a well-designed shape is improved control and stability during cleaning. Rounded edges, balanced proportions, and clear grip areas make the product easier to direct around windows, panels, and interior spaces. Shape also contributes to compactness, as efficient geometry allows components to be arranged without wasted space. However, shaping a multifunctional product presents challenges. Incorporating multiple internal components may limit external form options, and prioritising shape over internal layout could reduce performance.\n\nIf the shape criterion is not met, the product may feel awkward, unbalanced, or uncomfortable to use. This could discourage regular use and increase the risk of dropping or mishandling the kit, undermining both safety and portability. Shape will be evaluated through user handling tests, observation of grip comfort, and storage trials. The minimum standard for success is that the kit can be comfortably held and controlled during use, fits naturally in the hand, and can be stored efficiently without awkward positioning.' },
        { h: 'Colour', text: 'Colour in the context of this project refers to the selection and application of colours across the car-cleaning kit\'s body, controls, and components. Colour influences how users perceive the product, how easily they can identify functional parts, and how safe and intuitive the product feels during use. For a practical, handheld tool aimed at young drivers, colour is not purely decorative; it plays a role in usability, visibility, and user confidence, particularly in outdoor or low-light environments such as driveways and garages.\n\nThe goal of this criterion is to select a colour scheme that enhances visibility, communicates function clearly, and appeals to the target market without becoming distracting or impractical. Research into product and safety design shows that colour contrast helps users quickly identify controls and moving parts, reducing user error. Safe Work Australia highlights that high-contrast colours are commonly used to improve visibility and reduce risk when operating equipment, particularly where water, movement, or hand-held tools are involved. Applying this principle to the kit supports safer and more intuitive use.' },
        { h: 'Colour (continued)', text: 'One major advantage of an effective colour scheme is improved usability. For example, using contrasting colours for controls, nozzles, or grip areas helps users instantly recognise where to hold or adjust the product. Colour psychology research also suggests that neutral and darker tones such as grey, black, or navy are commonly associated with durability and cleanliness in tools, while limited accent colours can draw attention to key features (Interaction Design Foundation). This is particularly relevant for young drivers, who value products that look modern and practical rather than toy-like. However, there are challenges associated with colour selection. Light colours may show dirt and wear quickly, reducing perceived quality over time, while overly bright colours may clash with the product\'s intended professional and durable image.\n\nIf the colour criterion is not achieved, the product may appear cheap, confusing, or difficult to use. Poor colour contrast could make controls hard to identify, increasing the chance of misuse or frustration. This would negatively affect both safety and user satisfaction. Colour will be evaluated through visual assessment, user preference surveys, and observation during use. The minimum standard for success is that functional components are clearly visible, the product maintains a clean appearance after repeated use, and users report that the colour scheme looks appropriate and easy to understand.' }
      ],
      highlights: [
        { h: 'Shape — Design Research', text: 'Design Council UK: products with clear, ergonomic forms improve user confidence and reduce handling errors because users can easily understand how the product should be held and used. A streamlined, logical shape ensures the kit feels approachable and practical for inexperienced users.' },
        { h: 'Colour — Safety Application', text: 'Safe Work Australia: high-contrast colours are commonly used to improve visibility and reduce risk when operating equipment, particularly where water, movement, or handheld tools are involved. Applying this principle to the kit supports safer and more intuitive use.' }
      ]
    }
  },

  /* 8 — Criteria: Trends + Legislation */ {
    t: 'criteria',
    data: {
      cols: [
        ...
        { h: 'Trends (continued)', text: 'A major advantage of following these trends is increased relevance and long-term appeal. Products that align with current expectations are more likely to be adopted and recommended by users. Trend research in industrial design also highlights the move toward minimalist aesthetics and practical design, where products are easy to understand and use without complex instructions (Interaction Design Foundation). However, a challenge associated with trends is that they can change quickly. Designing too heavily around short-term trends risks the product becoming outdated, which could reduce its lifespan and perceived value.\n\nIf trends are not considered, the product may appear outdated, bulky, or unnecessary, especially to younger users who are highly influenced by modern design and social media exposure. This could result in poor adoption even if the product functions well. Trends will be evaluated by comparing the design against current car-care products on the market, analysing user feedback from the target audience, and reviewing whether the product aligns with contemporary expectations of convenience and sustainability. The minimum standard for success is that the kit reflects modern design values such as simplicity, multifunctionality, and environmental awareness, while remaining practical and relevant over time.' },
        ...
        { h: 'Legislation (continued)', text: 'One advantage of meeting legislative requirements is increased credibility and reduced risk of product failure or recall. The ACCC explains that unsafe consumer products can be banned, recalled, or subject to legal penalties, which would severely impact a product\'s viability. Designing with legislation in mind from the start reduces these risks. However, a challenge associated with legislative compliance is that regulations can limit certain design choices. For example, materials or mechanisms that appear innovative may be unsuitable if they fail to meet safety standards, forcing design compromises.\n\nIf legislative requirements are not met, the consequences are significant. The product could be deemed unsafe or illegal to sell, resulting in recalls, fines, or liability issues. This would undermine the entire project, regardless of how effective or attractive the product is. It would also conflict with the project\'s aim of promoting responsible and sustainable car-care practices.\n\nLegislative compliance will be evaluated by cross-checking the design against the Australian Consumer Law and relevant Work Health and Safety guidelines provided by Safe Work Australia. Risk assessments will be conducted to identify potential hazards, and the final design will be reviewed to ensure all foreseeable risks are minimised. The minimum standard for success is that the product complies with Australian Consumer Law requirements, contains no prohibited features, and can be used safely for its intended purpose without breaching any relevant legislation.' }
      ],
      highlights: [
        { h: 'Trends — McKinsey Research', text: 'McKinsey & Company: convenience and efficiency are key drivers in modern consumer product choices, especially among younger users who value time-saving solutions. Australian consumers increasingly prefer products that reduce water use and waste, particularly in everyday activities like car washing.' },
        { h: 'Legislation — Australian Consumer Law', text: 'Under the ACL, products sold to consumers must be safe, fit for purpose, and not pose foreseeable risks when used as intended. The ACCC can ban, recall, or impose legal penalties on unsafe consumer products — making compliance essential from the start of design.' }
      ]
    }
  },

  /* 9 — Criteria: Safety + Environmental Impact */ {
    t: 'criteria',
    data: {
      cols: [
        ...
        { h: 'Safety (continued)', text: 'One major benefit of prioritising safety is increased user confidence and willingness to use the product regularly. Products that feel safe and predictable are more likely to be adopted by younger users. Consumer safety guidance from Product Safety Australia notes that injuries often occur due to poor grip, exposed edges, or unclear operation, particularly in everyday household products. By addressing these risks, the design supports safe and independent use. However, a challenge associated with safety is that adding protective features such as guards or reinforced components can increase weight, size, or cost, which must be balanced carefully against other criteria like portability and compactness.\n\nIf safety is not adequately addressed, the consequences could be serious. Users may experience minor injuries such as hand strain or slips, or more severe incidents if the product behaves unpredictably. This would not only discourage use but could also result in complaints or legal issues.\n\nSafety will be evaluated through a risk assessment identifying potential hazards and testing the product in controlled conditions. User trials will observe handling, grip security, and stability during operation. The minimum standard for success is that the kit contains no sharp edges, maintains a secure grip when wet, operates predictably, and can be used without causing injury under normal conditions.' },
        ...
        { h: 'Environmental Impact (continued)', text: 'One major advantage of improving environmental impact is the promotion of responsible water use. Water360 reports that even commercial car washes, which are more regulated, can still use between 40 and 200 litres of water per vehicle depending on their equipment. This shows that water efficiency remains a challenge across the industry and that innovation at the consumer level can make a meaningful difference. However, a challenge associated with reducing environmental impact is ensuring that lower water use does not reduce cleaning performance. Users may increase washing time or repeat washes if results are poor, which would offset environmental benefits.\n\nIf environmental impact is not adequately addressed, the product risks contributing to the same issues it aims to solve, including water waste and chemical pollution. This would undermine the project\'s sustainability goals and reduce its appeal to environmentally conscious users.\n\nEnvironmental performance will be evaluated by comparing water usage during a wash using the kit against a standard hose and bucket wash. Observations will also assess soap usage and runoff volume. The minimum standard for success is that the kit uses noticeably less water than a typical home wash and limits excess detergent runoff, while still effectively cleaning the vehicle.' }
      ],
      highlights: [
        { h: 'Safety — Safe Work Australia', text: 'Effective safety design focuses on eliminating or minimising risks at the design stage, especially for handheld equipment and tasks involving water. Minimum standard: the kit contains no sharp edges, maintains a secure grip when wet, operates predictably, and can be used without causing injury under normal conditions.' },
        { h: 'Environmental Impact — ACWA', text: 'A typical home car wash uses over 100 litres of water and produces polluted runoff flowing directly into local waterways. Water360 reports commercial washes can use 40–200 litres per vehicle. Minimum standard: the kit uses noticeably less water than a typical home wash and limits excess detergent runoff.' }
      ]
    }
  },

  /* 10 — Criteria: Materials + Summary */ {
    t: 'criteria',
    data: {
      cols: [
        ...
        { h: 'Materials (continued)', text: 'One major advantage of selecting appropriate materials is increased product lifespan. Durable materials reduce the likelihood of cracking, leaking, or failure, which improves user trust and reduces waste. Research from CSIRO highlights that well-chosen polymers are commonly used in water-based consumer products because they offer a balance of strength, low weight, and resistance to moisture. However, a challenge associated with material selection is balancing durability with sustainability. Some strong plastics are difficult to recycle, which can increase environmental impact if not carefully considered.\n\nIf unsuitable materials are used, the product may degrade quickly, leak, or fail under pressure, leading to safety risks and poor user experience. This would undermine the project\'s goals of reliability and sustainability and could discourage users from adopting the product long-term. Poor material choices may also increase replacement frequency, contributing to unnecessary waste.\n\nMaterial success will be evaluated through visual inspection, stress testing, and water-exposure testing to observe wear, deformation, or leaks over time. The minimum standard for success is that all materials resist water damage, maintain structural integrity during repeated use, and do not degrade or fail when exposed to detergents and outdoor conditions.' },
        { h: 'Criteria Summary', text: 'Across these 10 criteria — Portability, Weight, Compactness, Shape, Colour, Trends, Legislation, Safety, Environmental Impact, and Materials — I have identified the key functional, aesthetic, ergonomic, and ethical requirements that my car-cleaning kit must meet. Each criterion has been researched through a combination of primary interviews, surveys of P-plate drivers, and secondary sources including Safe Work Australia, the Australian Car Wash Association, and Product Safety Australia.\n\nThese criteria collectively define what a successful product looks like for teenage and young drivers. They address the most significant barriers identified in my research: limited time, storage space, budget, and environmental concern. By designing against each criterion and setting a clear minimum standard for success, I can objectively evaluate my final product and ensure it genuinely meets the needs identified in my project proposal.\n\nThe criteria also guided decisions made throughout the design and production process, from the choice of lightweight durable materials to the ergonomic shape of handles and the selection of a colour scheme that is both safe and visually appealing. Each design decision can be traced back to one or more of these success criteria.' },
        { h: '', text: '' }
      ],
      highlights: [
        { h: 'Materials — CSIRO Research', text: 'CSIRO: well-chosen polymers are commonly used in water-based consumer products because they offer a balance of strength, low weight, and resistance to moisture. Minimum standard: all materials resist water damage, maintain structural integrity during repeated use, and do not degrade when exposed to detergents and outdoor conditions.' },
        { h: 'All 10 Criteria', text: 'Portability · Weight · Compactness · Shape · Colour · Trends · Legislation · Safety · Environmental Impact · Materials. Each criterion has been researched through primary interviews, P-plate driver surveys, and credible secondary sources, with a clear minimum standard for success defined for each.' }
      ]
    }
  },
